<template>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 d-flex justify-content-between align-items-baseline flex-wrap">
                <h2 class="offerheading">My Offer</h2>
                <span class="currentPrice">Current Asking Price $--</span>
            </div>
        </div>
        <div class="row">
